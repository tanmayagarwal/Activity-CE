    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lop_target', models.CharField(blank=True, help_text=' ', max_length=255, null=True, verbose_name='Life of WorkflowLevel1 (LoP) target*')),
                ('rationale_for_target', models.TextField(blank=True, help_text=' ', max_length=255, null=True)),
                ('target_frequency', models.IntegerField(choices=[(1, 'Life of WorkflowLevel1 (LoP) only'), (2, 'Midline and endline'), (3, 'Annual'), (4, 'Semi-annual'), (5, 'Tri-annual'), (6, 'Quarterly'), (7, 'Monthly'), (8, 'Event')], help_text=' ', null=True, verbose_name='Target frequency')),

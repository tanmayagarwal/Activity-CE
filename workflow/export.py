...
class ProjectAgreementResource(resources.ModelResource):
    ...
    project_type = fields.Field(
        column_name='project_type', attribute='project_type',
    ...
    estimated_by = fields.Field(
        column_name='estimated_by', attribute='estimated_by',
        widget=ForeignKeyWidget(ActivityUser, 'name'))
    approved_by = fields.Field(
        column_name='approved_by', attribute='approved_by',
        widget=ForeignKeyWidget(ActivityUser, 'name'))
...
class StakeholderResource(resources.ModelResource):
    ...
    filled_by = fields.Field(
        column_name='filled_by', attribute='filled_by',
        widget=ForeignKeyWidget(ActivityUser, 'name'))
    stakeholder_register = fields.Field(
        column_name='stakeholder_register', attribute='stakeholder_register')
    formal_relationship_document = fields.Field(
        column_name='formal_relationship_document',
        attribute='formal_relationship_document',
        widget=ForeignKeyWidget(Documentation, 'name_n_url'))
    vetting_document = fields.Field(column_name='vetting_document',
                                    attribute='vetting_document',
                                    widget=ForeignKeyWidget(Documentation,
                                                            'name_n_url'))

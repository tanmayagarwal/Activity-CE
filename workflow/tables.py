...
<div class="btn-group btn-group-xs">
   <a type="button" class="btn btn-warning" href="/workflow/
   projectagreement_update/{{ record.id }}">Edit</a>
   <a type="button" class="btn btn-default" href="/workflow/
   projectagreement_detail/{{ record.id }}">View</a>
</div>
'''
...
TEMPLATE2 = '''
   <a class="btn btn-default btn-xs" role="button" href="/incident/
   {{ record.id }}/print">Print</a>
'''

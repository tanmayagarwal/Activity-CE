...
from activity.models import (Location, Sector, Office, Organization)
from .models import (
    WorkflowLevel2, WorkflowLevel1, Documentation,
    Benchmarks, Monitor, Budget, ChecklistItem, Province,
    ActivityUser, Contact
)
...
#         queryset=WorkflowLevel1.objects.filter(funding_status__status="Funded"))
#
#     def __init__(self, *args, **kwargs):
#         # get the user object from request to check permissions
#         self.request = kwargs.pop('request')

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level_1_label', models.CharField(blank=True, default='WorkflowLevel1', max_length=255, verbose_name='Project/WorkflowLevel1 Organization IndicatorLevel 1 label')),
                ('level_2_label', models.CharField(blank=True, default='Project', max_length=255, verbose_name='Project/WorkflowLevel1 Organization IndicatorLevel 2 label')),
                ('level_3_label', models.CharField(blank=True, default='Component', max_length=255, verbose_name='Project/WorkflowLevel1 Organization IndicatorLevel 3 label')),
                ('level_4_label', models.CharField(blank=True, default='Activity', max_length=255, verbose_name='Project/WorkflowLevel1 Organization IndicatorLevel 4 label')),
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('justification_description_community_selection', models.TextField(blank=True, null=True, verbose_name='Description of Organization Selection Criteria')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Organization/Organization Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('village', models.CharField(blank=True, max_length=255, null=True, verbose_name='Administrative IndicatorLevel 4')),
                ...
                ('create_date', models.DateTimeField(blank=True, null=True)),
                ('edit_date', models.DateTimeField(blank=True, null=True)),
                ('admin_level_three', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.AdminLevelThree', verbose_name='Administrative IndicatorLevel 3')),
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.Country')),
                ('district', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.District', verbose_name='Administrative IndicatorLevel 2')),
                ...
                ('province', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='workflow.Province', verbose_name='Administrative IndicatorLevel 1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stakeholder', models.ManyToManyField(blank=True, to='workflow.Organization')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='projectagreement',
            name='stakeholder',
            field=models.ManyToManyField(blank=True, to='workflow.Organization', verbose_name='Stakeholders'),
        ),
        migrations.AddField(
            model_name='program',
            name='sector',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_level_three', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='workflow.AdminLevelThree', verbose_name='Administrative IndicatorLevel 3')),
                ...
                ('district', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='workflow.District', verbose_name='Administrative IndicatorLevel 2')),
                ...
                ('province', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='workflow.Province', verbose_name='Administrative IndicatorLevel 1')),

...
class FlatJsonSerializer(PythonSerializer):
    """
    Take a look at the django implementation as a reference
    ...
    Usage:
        ...
        json_data = serializer.serialize(<queryset>,
...
class ActivitytableSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = ActivityTable
        # HyperlinkedModelSerializer does not include id field
        # by default so manually setting it

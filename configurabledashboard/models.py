...
class DashboardTheme(models.Model):
    ...
    layout_dictionary = models.TextField(
        "Dashboard Layout Dictionary", null=True, blank=True)
...
class DashboardComponent(models.Model):
    ...
    data_required = models.CharField(
        "Required Data Type", max_length=255, blank=False)
    data_sources = models.ManyToManyField(
        ComponentDataSource, blank=False, related_name="datasourceset")
    data_map = models.TextField(
        "Data Mapping Dictionary", null=True, blank=True)
    create_date = models.DateTimeField(null=True, blank=True)
    edit_date = models.DateTimeField(null=True, blank=True)
...
class CustomDashboard(models.Model):
    ...
    components = models.ManyToManyField(
        DashboardComponent, blank=True, related_name="componentset")
    component_map = models.TextField(
        "Dashboard Layout Dictionary", null=True, blank=True)
    create_date = models.DateTimeField(null=True, blank=True)
    edit_date = models.DateTimeField(null=True, blank=True)
